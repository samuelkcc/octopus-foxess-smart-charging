...
systemctl disable --now octopus-foxess-worker.service octopus-foxess.service 2>/dev/null || true
rm -f /etc/systemd/system/octopus-foxess-worker.service /etc/systemd/system/octopus-foxess.service
